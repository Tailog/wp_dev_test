 ...
 * 
 * The Syntax of the file is very important for wordpress, to regognise it and be used by wordpress function => get_footer() 
 */
?>
    ...
    <?php
        // Function that call the callback in the functions.php with the wp_enqueue_scripts hook
        wp_footer();
        ?>
  </body>
</html>